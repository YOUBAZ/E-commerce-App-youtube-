    ...
    <>
      <div className="container mx-auto">
        <div className="flex md:flex-row">
          <div className="bg-[#F5F5F5] p-3 mt-2 mb-2">
            <h2 className="h4 text-center py-2 bg-gray-600 rounded-full mb-2 text-white">
            ...
            <h2 className="bg-gray-600 h4 text-center text-white py-2 rounded-full mb-2">
              Filter By Price
            </h2>
            <div className="p-5 w-[15rem]">
              <input
            ...
            <div className="p-5 pt-0">
              <button
                className="w-full border-my-4 bg-pink-500 rounded-full text-white"
